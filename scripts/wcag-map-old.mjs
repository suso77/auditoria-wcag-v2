...
const equivalencias = {
 ...
 "duplicate-aria-ids": "4.1.1",
 "role-presentation": "1.3.1",
 "aria-progressbar-name": "4.1.2",
 "aria-dialog-name": "4.1.2",


 "Principle1.Guideline1_1.1_1_1": "1.1.1",
 "Principle1.Guideline1_3.1_3_1": "1.3.1",
 "Principle1.Guideline1_4.1_4_3": "1.4.3",
 "Principle1.Guideline1_4.1_4_11": "1.4.11",
 "Principle2.Guideline2_1.2_1_1": "2.1.1",
 "Principle2.Guideline2_4.2_4_2": "2.4.2",
 "Principle2.Guideline2_4.2_4_4": "2.4.4",
 "Principle2.Guideline2_4.2_4_7": "2.4.7",
 "Principle3.Guideline3_1.3_1_1": "3.1.1",
 "Principle3.Guideline3_3.3_3_1": "3.3.1",
 "Principle4.Guideline4_1.4_1_2": "4.1.2",
 "Principle4.Guideline4_1.4_1_3": "4.1.3"
};


// ===========================================================
// 🧠 Función universal de normalización WCAG IAAP PRO
// ===========================================================
export function getWcagInfo(id = "") {
 ...
 // Buscar en equivalencias (reglas axe / pa11y → criterio WCAG)
 const match = equivalencias[clean];
 if (match && wcagMap[match]) {
   return { id, ...wcagMap[match] };
 }


 // Buscar coincidencia directa
 if (wcagMap[id]) {
   return { id, ...wcagMap[id] };
 }


 // Buscar coincidencia parcial (cuando id contiene el número del criterio)
 const found = Object.entries(wcagMap).find(([key]) => clean.includes(key));
 if (found) {
   return { id, ...found[1] };
 }


 // Si no se encuentra correspondencia, devolver objeto genérico
...
// ===========================================================
// ♻️ Alias retrocompatible para compatibilidad histórica
// ===========================================================
export const getWcagUniversal = getWcagInfo;


// ===========================================================
// 📘 Diccionario de nombres legibles WCAG IAAP PRO
// ===========================================================
export const wcagNombres = Object.fromEntries(
 Object.entries(wcagMap).map(([id, v]) => [id, `${v.criterio} (${v.nivel})`])
);
